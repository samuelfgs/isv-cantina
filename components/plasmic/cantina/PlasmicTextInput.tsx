...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: J6Bka2G1vC3V/css

import SearchSvgIcon from "./icons/search";
import CheckSvgIcon from "./icons/checksvg";
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__ndutM)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__e3PAt)}
              role={"img"}
            />
          ),
