...
import Select__Option from "../../Select__Option"; // plasmic-import: 2QIN1mncY2wG/component
...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 1zoysY8PGt1c/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: TQ2uLm_LONoV/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__vG3K0)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___2Mcmu)}
              />
            </React.Fragment>
          ),
          value: args.children
